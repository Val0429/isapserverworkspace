import {
    ...
    Action, Errors, O, EventFlow2StrictCompareFace,
} from 'core/cgi-package';

type EventStrictCompareFace = EventFlow2StrictCompareFace;
let EventStrictCompareFace = EventFlow2StrictCompareFace;
