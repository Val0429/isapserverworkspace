 ...
 * Action Create
 */
type InputC = IRequest.IDevice.IDwellTimeC[];
                ...
                _input.map(async (value, index, array) => {
                    try {
                        ...
                        let device: IDB.Device = await new Parse.Query(IDB.Device)
                            ...
                            .equalTo('mode', Enum.EDeviceMode.dwellTime)
                            .first()
                            .fail((e) => {
                                throw e;
                            });
                        ...
                        device.setValue('mode', Enum.EDeviceMode.dwellTime);
 ...
 * Action update
 */
type InputU = IRequest.IDevice.IDwellTimeU[];
