...
//  * Action Create
//  */
// type InputC = IRequest.IRule.IRepeatVisitorC[];
...
//                     try {
//                         let rule: IDB.RuleRepeatVisitor = await Rule.GetCreateBaseRuleObject(IDB.RuleRepeatVisitor, value);
...
//  * Action update
//  */
// type InputU = IRequest.IRule.IRepeatVisitorU[];
...
//                 _input.map(async (value, index, array) => {
//                     try {
//                         let rule: IDB.RuleRepeatVisitor = await Rule.GetUpdateBaseRuleObject(IDB.RuleRepeatVisitor, value);
...
//                     try {
//                         await Rule.Delete(IDB.RuleRepeatVisitor, value);
//                     } catch (e) {
//                         resMessages[index] = Parser.E2ResMessage(e, resMessages[index]);
