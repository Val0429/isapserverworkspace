...
//  * Action Create
//  */
// type InputC = IRequest.IRule.IVisitorC[];
...
//                     try {
//                         let rule: IDB.RuleVisitor = await Rule.GetCreateBaseRuleObject(IDB.RuleVisitor, value);

//                         rule.setValue('conditionVip', value.conditionVip);
//                         rule.setValue('conditionBlacklist', value.conditionBlacklist);
...
//  * Action update
//  */
// type InputU = IRequest.IRule.IVisitorU[];
...
//                 _input.map(async (value, index, array) => {
//                     try {
//                         let rule: IDB.RuleVisitor = await Rule.GetUpdateBaseRuleObject(IDB.RuleVisitor, value);

//                         if (value.conditionVip) {
//                             rule.setValue('conditionVip', value.conditionVip);
//                         }
//                         if (value.conditionBlacklist) {
//                             rule.setValue('conditionBlacklist', value.conditionBlacklist);
//                         }
...
//                     try {
//                         await Rule.Delete(IDB.RuleVisitor, value);
//                     } catch (e) {
//                         resMessages[index] = Parser.E2ResMessage(e, resMessages[index]);
