                    ...
                    next: async (x) => {
                        ...
                        try {
                            ...
                            if (this._config.output.saveSource) {
                                File.WriteFile(`${File.assetsPath}/images_report_source/demographic/${DateTime.ToString(report.createdAt, 'YYYYMMDD')}/${report.id}_report_${report.createdAt.getTime()}.bmp`, buffer);
                            }
